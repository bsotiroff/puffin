...
config :flying_penguin, FlyingPenguin.Repo,
  username: "postgres",
  password: "postgres",
  database: "flying_penguin_test#{System.get_env("MIX_TEST_PARTITION")}",
  hostname: "localhost",
...
config :flying_penguin, FlyingPenguin.Mailer, adapter: Swoosh.Adapters.Test
