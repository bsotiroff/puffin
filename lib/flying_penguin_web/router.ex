defmodule FlyingPenguinWeb.Router do
  use FlyingPenguinWeb, :router

  import FlyingPenguinWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {FlyingPenguinWeb.LayoutView, :root}
  ...
  if Application.get_env(:flying_penguin, :env) in [:dev, :test] do
